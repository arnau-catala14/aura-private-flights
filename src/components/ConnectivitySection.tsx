  ...
  return (
    <section ref={ref} className="bg-background">
      <div className="flex min-h-screen flex-col md:flex-row-reverse">
        {/* Image half with parallax — reversed side */}
        ...
        <div className="flex w-full flex-col justify-center px-8 py-20 md:w-1/2 md:px-16 lg:px-24">
          ...
          >
            Your office doesn't end at the tarmac. Every Aura aircraft is equipped with Ka-band 
            satellite connectivity delivering speeds that rival ground-based fibre. Run video 
            conferences, stream markets in real-time, or close deals across time zones — all at 
            Mach 0.85 with zero interruption.
          </motion.p>
          <motion.p
          ...
          >
            Integrated touchscreen panels control cabin lighting, temperature, entertainment, 
            and window shading from a single interface. Our proprietary flight-tracking display 
            lets you monitor your route, ETA, and weather conditions with the precision of 
          ...
          >
            Because true luxury isn't disconnecting from the world — it's commanding it 
            from wherever you choose to be.
          </motion.p>
        </div>
      </div>
    </section>
